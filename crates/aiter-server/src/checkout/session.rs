//! Checkout session REST surface: create / complete / cancel sessions.
...
use aiter_core::checkout::{CheckoutEvent, CheckoutSession, CheckoutStatus, Fulfillment};
use aiter_core::order::Order;
use aiter_core::pricing::{compute_totals, NoTax};
